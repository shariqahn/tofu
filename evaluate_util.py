        ...
        # do thing
            if cfg.use_pretrained:
                ...
                if ("WISE" in cfg.model_path):
                    ...
                    # model = AutoModelForCausalLM.from_pretrained(cfg.model_path, revision='checkpoint-60', config=config, use_flash_attention_2=False, torch_dtype=torch.float16, trust_remote_code = True, device_map=device_map)
