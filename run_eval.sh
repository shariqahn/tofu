...
path_to_eval_result=model_outputs/tofu_baseline_revert/eval_results/ds_size300/eval_log_aggregated.json

python aggregate_eval_stat.py retain_result=$path_to_eval_result ckpt_result=$path_to_eval_result method_name=Page8Right save_file=./model_outputs/tofu_baseline_revert/eval_results/ds_size300/Page8Right.csv
